...
- (void)layoutSubviews {
    ...
    self.volumeView.left        = self.volumeImgView.right + 10;
    self.volumeView.width    = self.width - self.volumeView.left - 5;
    self.volumeView.height   = 36.0f;
    self.volumeView.centerY  = self.height * 0.5f;
}
