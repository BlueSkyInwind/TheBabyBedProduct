...
- (UIView *)topLine {
    if (!_topLine) {
        _topLine = [UIView new];
        _topLine.backgroundColor = rgb(222, 222, 222, 1);
    }
    return _topLine;
}
...
- (UIView *)closeLine {
    if (!_closeLine) {
        ...
        _closeLine.backgroundColor = rgb(222, 222, 222, 1);
    }
    return _closeLine;
}
...
- (void)setModel:(GKWYMusicModel *)model {
    ...
    if (model.isPlaying) {
        ...
        self.nameLabel.textColor    = rgb(200, 38, 39, 1);
        self.artistLabel.textColor  = rgb(200, 38, 39, 1);
...
- (UIView *)lineView {
    if (!_lineView) {
        ...
        _lineView.backgroundColor = rgb(200, 38, 39, 1);
    }
    return _lineView;
}
