...
-(void)SetCryingThresholdValueComplication:(void(^)(BOOL isSuccess))finish{
    [BBRequestTool SetThresholdValueDeviceType:@"1" minValue:@"" maxValue:self.decibelTextField.text deviceId:BBUserHelpers.deviceId img:imgIDs successBlock:^(EnumServerStatus status, id object) {
