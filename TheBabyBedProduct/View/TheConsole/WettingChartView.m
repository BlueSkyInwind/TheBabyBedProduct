...
-(void)configureView{
    ...
    _dateChooseView = [DateChooseView initFrame:CGRectMake(0, 0, _k_w, 47) mainColor:rgb(173, 229, 69, 1)];
...
- (NSArray *)lines:(BOOL)fill {
    ...
    for (int i = 0; i < pointsArr.count; i++) {
        ...
        item.chartLineColor = rgb(173, 229, 69, 1);
        item.chartPointColor = rgb(173, 229, 69, 1);
        item.pointValueColor = rgb(173, 229, 69, 1);
