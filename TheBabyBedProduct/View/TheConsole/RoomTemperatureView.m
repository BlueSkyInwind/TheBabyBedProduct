...
-(void)configureView{
    ...
    _dateChooseView = [DateChooseView initFrame:CGRectMake(0, 0, _k_w, 47) mainColor:self.mainColor leftImage:@"roomTemChooseDate_left_Icon" rightImage:@"roomTemChooseDate_right_Icon"];
