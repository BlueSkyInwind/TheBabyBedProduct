...
-(void)configureViews
{
    ...
    // 进度条颜色
//    UIColor *tintColor = [UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0]; // iOS7 Safari bar color   240 170 16
    UIColor *tintColor = k_color_appOrange;
    ...
    _fadeOutDelay = 0.1f;
//    _barAnimationDuration = 10.0f;
//    _fadeAnimationDuration = 10.0f;
//    _fadeOutDelay = 10.0f;
}
